...
class ReviewView: ProgrammaticView {
    ...
    override func constrain() {
        ...
        NSLayoutConstraint.activate([
            ...
            lblContent.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 10),
            lblContent.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
            ivAuthor.topAnchor.constraint(equalTo: lblContent.bottomAnchor, constant: 10),
            ivAuthor.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
            ...
            lblAuthor.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 10),
            lblAuthor.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
